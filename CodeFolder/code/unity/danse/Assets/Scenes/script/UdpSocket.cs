...
private void ProcessInput(string input)
{
    ...
    if (input.Contains("distance poignet :"))
    {
        ...
        if (parts.Length > 1)
        {
            string distanceStr = parts[1].Trim(); // Supprimer les espaces autour du nombre
    ...
    {
        string decibelsStr = input.Substring("niveau_sonore_dB:".Length).Trim(); // Supprimer le préfixe et les espaces autour du nombre
        Debug.Log("Chaîne de niveau sonore reçue: " + decibelsStr); // Ajoutez ce log
